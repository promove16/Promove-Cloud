...
const envSchema = zod_1.z.object({
    ...
    GOOGLE_OAUTH_CLIENT_ID: zod_1.z.string().min(1).optional(),
    GOOGLE_OAUTH_CLIENT_SECRET: zod_1.z.string().min(1).optional(),
    GOOGLE_OAUTH_REDIRECT_URI: zod_1.z.string().url().optional(),
    LINKEDIN_OAUTH_CLIENT_ID: zod_1.z.string().min(1).optional(),
    LINKEDIN_OAUTH_CLIENT_SECRET: zod_1.z.string().min(1).optional(),
    LINKEDIN_OAUTH_REDIRECT_URI: zod_1.z.string().url().optional(),
