...
const envSchema = zod_1.z.object({
    ...
    UPSTASH_REDIS_HOST: zod_1.z.string().min(1).optional(),
    ...
    FROM_EMAIL: zod_1.z.string().default('noreply@promovecyc.com'),
});
...
const derivedRedisHost = parsed.data.UPSTASH_REDIS_HOST ??
    (() => {
        try {
