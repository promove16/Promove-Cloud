...
const envSchema = zod_1.z.object({
    ...
    GITHUB_CLIENT_ID: zod_1.z.string().min(1).optional(),
    GITHUB_CLIENT_SECRET: zod_1.z.string().min(1).optional(),
    GITHUB_OAUTH_CALLBACK_URL: zod_1.z.string().url().optional(),
    ...
    EMAIL_USER: zod_1.z.string().min(1).optional(),
    EMAIL_PASS: zod_1.z.string().min(1).optional(),
