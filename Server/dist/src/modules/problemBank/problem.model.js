...
const submissionConfigSchema = new mongoose_1.Schema({
...
const problemSchema = new mongoose_1.Schema({
    ...
    securityNotice: {
        type: String,
        default: 'Upload only project-safe evidence. Do not share secrets, credentials, private keys, personal data, or production database exports.',
        trim: true,
        maxlength: 500,
    },
    publicationStatus: {
    ...
    createdByAdminId: { type: mongoose_1.Schema.Types.ObjectId, ref: 'User', default: undefined },
