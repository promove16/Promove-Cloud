    ...
    <section className="border-t border-slate-800/80 pt-8">
      ...
      {visible.length > 0 ? (
        <div className="relative mt-4 pl-10">
          <div className="absolute bottom-2 left-3.5 top-2 w-px bg-slate-800/80" />
          <div className="space-y-6">
            {visible.map((item, index) => (
              <article key={item.id} className="relative border-b border-slate-800/80 pb-5 last:border-b-0 last:pb-0">
                <span
