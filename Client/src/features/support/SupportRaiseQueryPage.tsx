  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid gap-6 xl:grid-cols-[minmax(0,1.35fr),minmax(280px,0.65fr)]">
        <Card className="space-y-6 border-slate-800 bg-slate-950 p-6">
          <div>
          ...
          <div>
            ...
            <div className="mt-2 space-y-2">
              {attachments.map((item) => (
                <div
                  key={item.id}
                  className="flex items-center justify-between gap-3 rounded-xl border border-slate-800 bg-slate-900 px-3 py-2 text-sm text-slate-200"
                >
            ...
            <div className="mt-4 space-y-3">
              {suggestedFaqs.length === 0 ? (
                ...
                suggestedFaqs.map((faq) => (
                  <div key={faq.id} className="rounded-2xl border border-slate-800 bg-slate-900 px-4 py-3">
