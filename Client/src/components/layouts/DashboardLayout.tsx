...
function NotificationBell() {
  ...
  return (
    <DropdownMenu>
      ...
      <DropdownMenuContent
        align="end"
        className="w-[22rem] border-slate-800 bg-slate-950 text-white"
      >
        <div className="flex items-center justify-between px-2 py-1">
          <DropdownMenuLabel className="px-0 text-sm font-semibold text-white">
            Notifications
          </DropdownMenuLabel>
          <button
            type="button"
...
export const SIDEBAR_CONFIG: Record<UserRole, NavItem[]> = {
  ...
  [UserRole.SCHOOL]: [
    ...
    },
    {
      ...
      label: "Investors",
      icon: Globe,
      path: "/dashboard/school/investors",
    },
    {
      kind: "link",
      label: "Mentors",
    ...
    },
    {
      ...
      icon: FileText,
      path: "/dashboard/school/compliance",
    },
    {
      kind: "link",
      label: "Settings",
  ...
  [UserRole.COLLEGE]: [
    ...
    },
    {
      ...
      path: "/dashboard/college/recruiters",
    },
    {
      kind: "link",
      label: "Investors",
      icon: Globe,
      path: "/dashboard/college/investors",
    },
    {
      kind: "link",
      label: "Mentors",
    ...
    },
    {
      ...
      icon: BarChart3,
      path: "/dashboard/college/placement",
    },
    {
      kind: "link",
      label: "Events",
      icon: Sparkles,
      path: "/dashboard/college/events",
    },
    {
      kind: "link",
      label: "Compliance Report",
      icon: FileText,
      path: "/dashboard/college/compliance",
    },
    {
      kind: "link",
      label: "Settings",
  ...
  [UserRole.RECRUITER]: [
    ...
    },
    {
      ...
      label: "Talent Search",
      icon: Users,
      path: "/dashboard/recruiter/talent",
    },
    {
      kind: "link",
      label: "College Connect",
      icon: Globe,
      path: "/dashboard/recruiter/colleges",
    },
    {
      kind: "link",
      label: "Active Drives",
      icon: BarChart3,
      path: "/dashboard/recruiter/drives",
    },
    {
      kind: "link",
        ...
        >
          ...
          <div className="mt-8 rounded-3xl border border-slate-800 bg-slate-900/70 p-5">
            ...
            <p className="mt-2 text-sm leading-6 text-slate-400">
              Role-aware access is controlled from a single sidebar config so
              navigation stays auditable.
            </p>
          </div>
        </aside>
