...
export const SIDEBAR_CONFIG: Record<UserRole, DashboardNavItem[]> = {
  ...
  [UserRole.SCHOOL]: [
    ...
    { kind: 'link', label: 'Projects', icon: FolderKanban, path: '/dashboard/school/projects' },
    { kind: 'link', label: 'Patents', icon: FileText, path: '/dashboard/school/patents' },
    { kind: 'link', label: 'Startups', icon: Rocket, path: '/dashboard/school/startups' },
    { kind: 'link', label: 'Events', icon: CalendarDays, path: '/dashboard/school/events' },
    { kind: 'link', label: 'Investors', icon: BriefcaseBusiness, path: '/dashboard/school/investors' },
    { kind: 'link', label: 'Mentorship', icon: GraduationCap, path: '/dashboard/school/mentors' },
    { kind: 'link', label: 'Operations', icon: Settings2, path: '/dashboard/school/operations' },
  ...
  [UserRole.COLLEGE]: [
    ...
    { kind: 'link', label: 'Projects', icon: FolderKanban, path: '/dashboard/college/projects' },
    ...
    { kind: 'link', label: 'Investors', icon: Building2, path: '/dashboard/college/investors' },
    { kind: 'link', label: 'Mentorship', icon: GraduationCap, path: '/dashboard/college/mentors' },
    { kind: 'link', label: 'Operations', icon: Settings2, path: '/dashboard/college/operations' },
