...
export const SIDEBAR_CONFIG: Record<UserRole, DashboardNavItem[]> = {
  ...
  [UserRole.INVESTOR]: [
    ...
    { kind: 'link', label: 'Portfolio', icon: Trophy, path: '/dashboard/investor/portfolio' },
  ...
  [UserRole.ADMIN]: [
    ...
    { kind: 'link', label: 'Patent Requests', icon: FileCheck, path: '/dashboard/admin/patent-requests' },
